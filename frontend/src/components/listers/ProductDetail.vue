<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <Number label="ProductNm" v-model="item.productNm" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Number label="StockQty" v-model="item.stockQty" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
